...
import {IMockVault, IBalancerComposableMockVault, ICurve2TokenConvexMockVault} from "../../interfaces/IMockVault.sol";
...
contract nMockProxy is ERC1967Proxy {
    ...
    function _implementation() internal view virtual override returns (address impl) {
        if (msg.sig == IBalancerComposableMockVault.joinPoolAndStake.selector ||
            msg.sig == ICurve2TokenConvexMockVault.joinPoolAndStake.selector || 
