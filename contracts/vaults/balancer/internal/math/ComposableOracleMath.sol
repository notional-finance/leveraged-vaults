...
library ComposableOracleMath {
    ...
    //     uint256 scaleFactor = poolContext.scalingFactors[index2] * BALANCER_PRECISION 
    //         / poolContext.scalingFactors[index1];
    //     spotPrice = spotPrice * BALANCER_PRECISION / scaleFactor;

    //     // Convert precision back to 1e18 after downscaling by scaleFactor
    //     spotPrice = spotPrice * BALANCER_PRECISION / (10**poolContext.basePool.decimals[index2]);
    // }
}
