...
def test_reinvest_reward(StratStableETHstETH):
    ...
    reinvest_reward(context, accounts[0], rewardAmount, rewardParams, bptBefore, 120917923093565119)
...
def test_reinvest_0x_trade(StratStableETHstETH, request):
    ...
    reinvest_reward(context, accounts[0], rewardAmount, rewardParams, bptBefore, 120928548527590752, True) # shouldRevert = True
    ...
    reinvest_reward(context, accounts[0], rewardAmount, rewardParams, bptBefore, 120928548527590752)
