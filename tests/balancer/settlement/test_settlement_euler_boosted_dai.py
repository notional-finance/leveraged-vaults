...
def test_normal_single_maturity(StratEulerBoostedPoolDAIPrimary):
...
def test_post_maturity_single_maturity(StratEulerBoostedPoolDAIPrimary):
...
def test_emergency_single_maturity(StratEulerBoostedPoolDAIPrimary):
