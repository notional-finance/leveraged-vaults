...
def get_oracles(oracles):
    return [{
        "symbol": o,
        "tokenAddress": token[o],
        "oracleAddress": oracle[o]
    } for o in oracles]
...
def generate_files(yaml_file, template_file):
    output_dir = "./tests/SingleSidedLP/pools/generated"
    ...
    for test in tests['arbitrum']:
        ...
        test['oracles'] = get_oracles(test['oracles'])
...
if __name__ == "__main__":
    ...
    generate_files(yaml_file, template_file)
