...
contract Test_PendlePT_sUSDe_28MAY2025_USDC is BasePendleTest {
    function setUp() public override {
        FORK_BLOCK = 21644500;
        WHALE = 0x40ec5B33f54e0E8A33A975908C5BA1c14e5BbbDf;
        harness = new Harness_PendlePT_sUSDe_28MAY2025_USDC();
...
contract Harness_PendlePT_sUSDe_28MAY2025_USDC is PendleStakingHarness {

    function getVaultName() public pure override returns (string memory) {
        return 'Pendle:PT sUSDe 28MAY2025:[USDC]';
    }
...
contract Deploy_PendlePT_sUSDe_28MAY2025_USDC is Harness_PendlePT_sUSDe_28MAY2025_USDC, DeployProxyVault {
    function setUp() public override {
        harness = new Harness_PendlePT_sUSDe_28MAY2025_USDC();
    }
